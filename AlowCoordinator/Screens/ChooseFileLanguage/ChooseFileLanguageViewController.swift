//
//  ChooseFileLanguageViewController.swift
//  AlowCoordinator
//
...
class ChooseFileLanguageViewController: BaseViewController {
    
    private let viewModel: ChooseFileLanguageViewModel
    ...
    init(viewModel: ChooseFileLanguageViewModel) {
...
extension ChooseFileLanguageViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        service?.fromLanguage = Language.allCases[indexPath.row]
        if let service = service {
            viewModel.navigateToChooseTranslateLanguage(with: service)
        }
    }
}
